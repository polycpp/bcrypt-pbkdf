# Sphinx configuration for the bcrypt-pbkdf companion library.
#
...
html_theme_options = {
    ...
    'source_repository': 'https://github.com/polycpp/bcrypt-pbkdf',
...
html_baseurl = 'https://polycpp.github.io/bcrypt-pbkdf/'
