...
- TypeScript declarations reviewed: TODO
- declaration-source decision: TODO
...
- Node parity hints consumed: TODO
- security hints consumed: TODO
- security-sensitive package: TODO
- polycpp capability snapshot consumed: TODO
- transport/listener capability hints consumed: TODO
...
- server/listener APIs: TODO (listen modes including TCP, Unix/IPC path, adopted handle when relevant, accepted connection type, lifecycle, and C++ adapter)
- diagnostic/tracing APIs: TODO
- streams: TODO (object-mode chunk type and exact C++ adapter)
- Buffer and binary data: TODO
- URL/timer/process/filesystem APIs: TODO (connect vs per-operation vs pool/idle deadlines and post-timeout resource state)
- crypto/compression/TLS/network/HTTP APIs: TODO (separate client transport, server/listener lifecycle, Unix/IPC path support, and TLS client/server modes when relevant)
